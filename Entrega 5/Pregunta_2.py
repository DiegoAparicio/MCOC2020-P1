# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 20:37:35 2020
...
t3 = perf_counter()
sol_euler = eulerint(zpunto,z0,t,Nsub=1)
t4 = perf_counter()

tiempo_eulerint = t4 - t3
...
print (f"El tiempo que toma odeint en producir los resultados es de: {tiempo_odeint} segundos")
print (f"El tiempo que toma eulerint en producir los resultados es de: {tiempo_eulerint} segundos")
print (f"La deriva de eulerint vs odeint al final del tiempo es de: {delta_euler[-1]/1000-delta[-1]/1000} Km")


plt.figure()
plt.plot(t/3600,delta/1000,label="Odeint")
plt.plot(t/3600,delta_euler/1000,label="Eulerint Nsub=1")
plt.suptitle(f" $\\delta_{{max odeint}} = {delta[-1]/1000:.1f}$ (Km) , $\\delta_{{max eulerint}} = {delta_euler[-1]/1000:.1f}$ (Km)")
